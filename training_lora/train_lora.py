...
dataset = load_dataset(
    "json",
    data_files="dataset/finetune_dataset_fix.json"
)["train"]
...
trainer.train(
    ...
    resume_from_checkpoint="./lora_output/checkpoint-16000"
...
print("training_logs_fix.csv saved!")
...
test_dataset.to_json(
    "test_dataset_fix.json"
)

print("test_dataset_fix.json saved!")
